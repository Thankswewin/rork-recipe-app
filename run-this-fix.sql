...
-- Run this script in your Supabase SQL Editor to completely fix the messaging system
-- This will drop and recreate all messaging tables with proper non-recursive policies

-- Step 1: Drop all existing messaging-related objects to start fresh
...
-- Conversations policies - Use a simple subquery approach
...
-- Conversation participants policies - Use direct user_id check where possible
...
-- Messages policies - Use simple subquery approach
...
BEGIN
  ...
  RAISE NOTICE 'All infinite recursion issues should now be resolved';
END $$;